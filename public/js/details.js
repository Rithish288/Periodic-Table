...
history.innerHTML = `<tag>History</tag><br/> <br/> <ul>${updatedHistory.join("<br/>")}</ul><br/>
    <small>For more info on history visit 
      <a href="https://en.wikipedia.org/wiki/${atomData.name}#History" target="_blank"> Wikipedia</a>
    </small>`
